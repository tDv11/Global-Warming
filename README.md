...
As you can see in the next graph, the tempature is going from the buttom to the top of the graph, and if we will glue the average of 2014 to it's back we will see a wave that repeating it self.
